/**
 * Branded Template
 * Same as Professional, with a logo section at the top.
 * Pass logoBase64 as a data URI string to display your logo image.
 * If omitted, a placeholder rectangle with "Your Logo" is shown instead.
 */
...
<head>
  ...
  <style>
    *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .page { width: 100%; min-height: 100vh; padding: 48px 56px 48px; position: relative; }
    /* Logo section */
    .logo-section { margin-bottom: 28px; }
    .logo-img { max-height: 72px; max-width: 240px; object-fit: contain; display: block; }
    .logo-placeholder {
    ...
    .logo-placeholder-text { font-size: 13px; color: #94a3b8; font-weight: 600; letter-spacing: 0.5px; }
    /* Header */
